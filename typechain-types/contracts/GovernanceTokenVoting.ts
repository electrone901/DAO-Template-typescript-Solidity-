...
export interface GovernanceTokenVotingInterface extends utils.Interface {
  functions: {
...
export interface GovernanceTokenVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernanceTokenVotingInterface;
